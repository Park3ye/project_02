...
// makeDivName : 생성할 코드의 이름
// lihnkFile : 외부에서 불러올 링크 파일이름
// wrapColorBoolean : 부모태그에서 불러온 태그의 배경색상을 가져 올 것인지 판단.

var wrap = $('#wrap');
// 1. 파잉 이름을 만들어서 부모태그를 생성
...
//불러온 파일의 배경색상을 부모태그에 적용할 지 판단 유무
